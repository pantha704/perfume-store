...
-- scent notes and demo prices). Running it against any project would
-- repopulate the database with obsolete, fabricated catalogue data.
--
-- The active seed at supabase/seed.sql is intentionally empty until the
-- client supplies confirmed prices/MRP, SKUs, sizes, weights and concentrations.
-- ============================================================================
