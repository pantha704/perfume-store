...
export function DiscoveryBand({ discovery }: { discovery?: Product }) {
  ...
  return <section className="discovery-band section-shell">
    ...
    <div className="discovery-art" data-parallax="0.15" data-reveal="right" style={{"--accent":discovery.accent} as React.CSSProperties}><span>5 × 2 ml</span><Image src={discovery.image} alt={discovery.imageAlt} width={640} height={820}/><i>wear before you decide</i></div>
  </section>;
}
