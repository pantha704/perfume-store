...
export default async function HomePage(){
  ...
  return <><CinematicHero/><div className="paper-world"><OfferBand/><FeaturedEdit products={products}/><ScentFamilies products={products}/><DiscoveryBand discovery={discovery}/><section className="manifesto section-shell"><p className="manifesto-number" data-parallax="0.20" data-reveal="left">03:17</p><div data-reveal="up"><p className="kicker">A note on choosing</p><h2>A perfume is not<br/>a profile picture.</h2><p>It moves with weather, skin and time. We show the first spray, the third hour and the trace left after. That is why every full bottle has a smaller way in.</p><Link href="/quiz" className="inline-arrow">Find your atmosphere <ArrowUpRight width={17}/></Link></div></section></div></>;
}
